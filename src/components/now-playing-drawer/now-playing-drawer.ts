...
/**
 * Generated class for the NowPlayingDrawerComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'now-playing-drawer',
  templateUrl: 'now-playing-drawer.html'
})
export class NowPlayingDrawerComponent {
  ...
  ngAfterViewInit() {
    ...
    this.renderer.setElementStyle(this.element.nativeElement, 'top', '82%');
  ...
  handlePan(ev){
    ...
    if((newTop < this.thresholdTop && ev.additionalEvent === "panup") || bounceToTop){
      ...
      this.domCtrl.write(() => {
        ...
        this.renderer.setElementStyle(this.element.nativeElement, 'top', '130px');
      });
