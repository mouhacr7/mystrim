...
import { NavController, NavParams, Navbar, Content, LoadingController, IonicPage, IonicModule } from 'ionic-angular';
...
import { albums } from './../../app/globals/constants';
import { Artist } from '../../app/globals/artist';
...
export class AlbumPage implements OnInit{
  ...
  ngOnInit() {
    this.getDocuments();
    this._album = this.navParams.data
